...
$id = $_GET['id'] ?? 0;
$sql = "SELECT df.*, r.name_of_the_item, r.item_specification, r.lab_id, l.lab_name
...
$pdf->Cell(0, 10, 'Lab: ' . $data['lab_name'], 0, 1);
$pdf->Cell(0, 10, 'Item: ' . $data['name_of_the_item'] . ' (' . $data['item_specification'] . ')', 0, 1);
$pdf->Cell(0, 10, 'Weight: ' . ($data['weight'] ?: 'N/A'), 0, 1);
$pdf->Cell(0, 10, 'Book Value: ' . ($data['book_value'] ?: 'N/A'), 0, 1);
